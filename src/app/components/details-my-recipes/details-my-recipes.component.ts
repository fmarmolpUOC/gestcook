...
@Component({
  selector: 'app-details-my-recipes',
  templateUrl: './details-my-recipes.component.html',
  styleUrls: ['./details-my-recipes.component.css']
})
export class DetailsMyRecipesComponent implements OnInit {
